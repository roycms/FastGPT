...
const defaultFeConfigs: FastGPTFeConfigsType = {
  show_emptyChat: true,
  show_git: true,
  docUrl: 'http://doc.huggingface.org.cn/?t=文档地址',
  openAPIDocUrl: 'http://doc.huggingface.org.cn/openAPIDocUrl.html?t=API文档地址',
  systemPluginCourseUrl:
    'http://doc.huggingface.org.cn/systemPluginCourseUrl.html?t=自定义插件文档地址',
  appTemplateCourse: 'http://doc.huggingface.org.cn/appTemplateCourse.html?t=飞书地址',
  systemTitle: '华链智能',
  concatMd: '项目地址: [华链智能AI服务平台](http://doc.huggingface.org.cn/)',
  limit: {
